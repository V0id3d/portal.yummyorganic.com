...
@section('main-content')
    <header class="header no-border" style="margin-bottom: 0;">
        <div class="header-info">
            <div class="left">
                <h2 class="header-title"><strong>Access Center</strong> Permission List</h2>
            </div>

            <div class="right gap-items-2">
                <a class="btn btn-secondary btn-square btn-round" href="{{ route('UserCenter.Permissions.Create') }}" data-provide="tooltip" title="" data-original-title="Add a Permission"><i class="fa fa-plus"></i></a>
        ...
        <div class="media-list media-list-divided media-list-hover" data-provide="selectall">
            ...
            <header class="flexbox align-items-center media-list-header bg-transparent b-0 py-16 pl-20">
                <div class="flexbox align-items-center">
                    ...
                    {{--<a class="btn btn-sm" href="{{ route('UserCenter.Permissions.Create') }}">--}}
                    ...
                    <div class="media align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; top: 19px; left: -147px; will-change: top, left;">
                                <a class="dropdown-item" href="{{ route('UserCenter.Permissions.Edit', $permission) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
...
@section('custom-javascript')
    <script>
        ...
        $('button').on('click', function(){
            app.toast('Something seems to have gone wrong.', {
                actionTitle: 'Retry',
                actionUrl: '{{ redirect()->back() }}',
                actionColor: 'danger'
            });
        });
        @endif
