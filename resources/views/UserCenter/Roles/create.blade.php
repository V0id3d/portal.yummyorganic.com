...
<header class="header no-border" xmlns="http://www.w3.org/1999/html">
    <div class="header-info">
        <div class="left">
            <h2 class="header-title"><strong>Access Center</strong> Add Role</h2>
        </div>
    </div>
</header>
        ...
        <div class="col-12">
            <div class="card card-shadowed form-type-material">
                <header class="card-header">
                    <h4 class="card-title"><strong>Create</strong> Role</h4>
                </header>

                <div class="card-body">
                    <form action="{{ route('UserCenter.Roles.Store') }}" method="POST">
                        {{ csrf_field() }}
