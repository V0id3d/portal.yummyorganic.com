...
@section('main-content')
    <header class="header no-border" style="margin-bottom: 0;">
        <div class="header-info">
            <div class="left">
                <h2 class="header-title"><strong>Customer Center</strong> Company List</h2>
            </div>

            <div class="right gap-items-2">
                <a class="btn btn-secondary btn-square btn-round" href="{{ route('CustomerCenter.Company.Create') }}" data-provide="tooltip" title="" data-original-title="Add a Permission"><i class="fa fa-plus"></i></a>
                    ...
                    <div class="media align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; top: 19px; left: -147px; will-change: top, left;">
                                <a class="dropdown-item" href="{{ route('CustomerCenter.Company.Edit', $company) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
